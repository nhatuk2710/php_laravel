...
<div class="site-wrap">
    ...
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="home.blade.php">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Shop</strong></div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-9 order-2 order-lg-1">
                    ...
                    <div class="row align">
                        <div class="col-md-12 mb-5">
                            <div class="float-md-left"><h1 class="text-black h5">All Products</h1></div>
                            <div class="d-flex">
                                        ...
                                        <div class="col-6 col-md-6 col-lg-6 border-top">
                                            <a href="product.blade.php" class="item">
                                                ...
                                                <div class="item-info">
                                                    ...
                                                    <span class="collection d-block">{{$b->product_desc}}</span>
