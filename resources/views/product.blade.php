...
<html lang="en">
  ...
  <div class="site-wrap">
          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li><a href="listproduct.blade.php">Shop</a></li>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href={{url("/")}}>Home</a> <span class="mx-2 mb-0">/</span> <a href="listproduct.blade.php">Shop</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">The Shoe</strong></div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="border">
              <img src={{url("images/product_1.jpg")}} alt="Image" class="img-fluid">
            </div>
          </div>
          <div class="col-md-6">
            ...
            <p><a href="html/cart.html" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary">Add To Cart</a></p>
      ...
      <div class="container">
        <div class="row">
          <div class="title-section text-center col-12">
            <h2 class="text-uppercase">Relative Products</h2>
          </div>
        </div>
        <div class="row">
